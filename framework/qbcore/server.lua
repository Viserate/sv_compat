...
Compat.Framework.backend = 'qbcore'
Compat.Framework.Core = QBCore
...
Compat.Framework.GetIdentifier = function(src)
	...
	return player.PlayerData.citizenid or player.PlayerData.license or player.PlayerData.license2
end
...
print('[sv_compat] framework backend: qbcore')
